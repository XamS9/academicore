...
- **`docs/e2e-admin-playbook.md`**, **`docs/e2e-teacher-playbook.md`**, **`docs/e2e-student-playbook.md`** — End-to-end checklists for seeded E2E users (`admin.e2e`, `teacher.e2e`, `student.e2e`); same **role** passwords as demo: `admin123`, `teacher123`, `student123`.
