-- ============================================================
-- ACADEMICORE — Custom DB Objects (Triggers & Stored Procedures)
-- ============================================================

-- ─────────────────────────────────────────────
-- TRIGGER FUNCTION: fn_generate_academic_record
...
DROP TRIGGER IF EXISTS trg_generate_academic_record ON grades;
CREATE TRIGGER trg_generate_academic_record
  AFTER INSERT OR UPDATE ON grades
  FOR EACH ROW EXECUTE FUNCTION fn_generate_academic_record();

-- ─────────────────────────────────────────────
-- STORED PROCEDURE (FUNCTION): sp_enroll_student
