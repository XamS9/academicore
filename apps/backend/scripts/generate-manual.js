...
const PAGES = {
  ADMIN: [
    ...
    },
    {
      ...
      desc: "Parámetros globales en pestañas: Académico (aprobatoria, máximo de materias, máx. créditos por materia, peso de evaluaciones, riesgo), Finanzas (costo por crédito, inscripción, mínimo de estudiantes por grupo, ciclos por año), Certificados (firmas en PDF) y Admisión (crear o editar motivos estándar de rechazo de documentos de inscripción: texto, código opcional, orden y activo). Los tres primeros bloques se guardan con un solo botón «Guardar»; en Admisión cada motivo se guarda al confirmar en el diálogo.",
      extras: [
        {
          label: "Tab: Admisión",
          desc: "Pestaña para administrar el catálogo de motivos de rechazo: tabla con orden, código y activo, botón Nuevo motivo o lápiz para editar, con guardado al cerrar el diálogo.",
          setup: async (page) => {
            await clickTabByLabel(page, "Admisión");
            await delay(600);
          },
        },
      ],
