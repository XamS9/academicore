...
export class SystemSettingsService {
  ...
  async update(dto: UpdateSystemSettingsDto, userId: string) {
    ...
    if (
      dto.minStudentsToOpenGroup !== undefined &&
      settings.minStudentsToOpenGroup !== dto.minStudentsToOpenGroup
    ) {
      oldValues.minStudentsToOpenGroup = settings.minStudentsToOpenGroup;
      newValues.minStudentsToOpenGroup = dto.minStudentsToOpenGroup;
    }
    if (
    ...
    const updated = await prisma.systemSettings.update({
      ...
      data: {
        ...
        ...(dto.minStudentsToOpenGroup !== undefined && {
          minStudentsToOpenGroup: dto.minStudentsToOpenGroup,
        }),
        ...(dto.maxCreditsPerSubject !== undefined && {
