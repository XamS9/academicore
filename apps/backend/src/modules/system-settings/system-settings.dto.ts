...
export const UpdateSystemSettingsDto = z.object({
  ...
  /**
   * Mínimo de estudiantes inscritos para que el grupo cuente como «abierto».
   * 0 = sin regla. Con inscripción cerrada, grupos por debajo habilitan solicitud de tutoría.
   */
  minStudentsToOpenGroup: z.number().int().min(0).max(500).optional(),
