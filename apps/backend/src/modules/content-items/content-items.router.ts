...
contentItemsRouter.post('/', authenticate, authorize('ADMIN', 'TEACHER'), controller.create);
contentItemsRouter.patch('/:id', authenticate, authorize('ADMIN', 'TEACHER'), controller.update);
contentItemsRouter.delete('/:id', authenticate, authorize('ADMIN', 'TEACHER'), controller.delete);
