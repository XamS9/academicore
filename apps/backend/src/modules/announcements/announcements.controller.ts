...
class AnnouncementsController {
  ...
  findMy = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const announcements = await announcementsService.findMy(req.user!.sub, req.user!.userType);
      res.json(announcements);
    } catch (err) {
      next(err);
    }
  ...
  create = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const announcement = await announcementsService.create(req.user!.sub, data);
  ...
  update = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const announcement = await announcementsService.update(req.params.id, data);
      res.json(announcement);
    } catch (err) {
      next(err);
    }
