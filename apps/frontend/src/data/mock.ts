...
export const mockSubjects: MockSubject[] = [
  ...
  { id: 'sub-003', name: 'Prog. Orientada a Objetos', credits: 8, code: 'SIS-201' },
...
export const mockCertificationCriteria: MockCertificationCriteria[] = [
  {
    ...
    minGrade: 6.0,
    validityMonths: 12,
    description: 'Historial académico oficial con todas las materias cursadas y calificaciones finales.',
  },
  {
    id: 'crit-002',
    type: 'ENROLLMENT_PROOF',
    ...
    minGrade: 6.0,
    validityMonths: 6,
    description: 'Comprobante de inscripción vigente para el período académico actual.',
  },
  {
    id: 'crit-003',
    type: 'COMPLETION',
    ...
    minGrade: 7.0,
    validityMonths: 24,
    description: 'Certificado de terminación de estudios al completar todos los créditos.',
  },
];
