            ...
            <Box className="flex items-start gap-3">
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Academicore es una plataforma integral para la administración
                  académica universitaria. Gestiona estudiantes, profesores,
                  inscripciones, evaluaciones, calificaciones y certificaciones
                  digitales con trazabilidad completa mediante registros de
                  auditoría. El sistema implementa control de acceso basado en
                  roles (RBAC), procedimientos almacenados para inscripciones
                  con validación de cadena completa, y generación automática de
                  registros académicos vía triggers de base de datos.
                </Typography>
