        ...
        >
          ...
          <DialogContent className="flex flex-col gap-4 pt-2">
            ...
            <NumericTextField
              ...
              value={form.minGrade}
              onValueChange={(minGrade) =>
                setForm((f) => ({ ...f, minGrade: Math.max(0, Math.min(10, minGrade)) }))
              }
              min={0}
              max={10}
              fullWidth
            ...
            <NumericTextField
              ...
              onValueChange={(validityMonths) =>
                setForm((f) => ({
                  ...f,
                  validityMonths: Math.max(1, Math.min(60, validityMonths)),
                }))
              }
              min={1}
              max={60}
