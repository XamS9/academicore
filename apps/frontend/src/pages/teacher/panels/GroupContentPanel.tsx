...
export default function GroupContentPanel({ groupId }: Props) {
  ...
  const openCreateTopic = () => {
    setEditTopic(null);
    setTopicForm({ groupId, title: "", description: "", sortOrder: topics.length + 1 });
  ...
  const handleSaveTopic = async () => {
    try {
      const payload = { ...topicForm, description: topicForm.description || undefined };
      if (editTopic) {
    ...
    <Box>
                    ...
                    primary={
                      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                        ...
                        <Chip
                          ...
                          size="small" color={typeColors[item.type]} variant="outlined"
                        />
                      </Box>
                    }
      ...
      <Dialog open={topicDialogOpen} onClose={() => setTopicDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent className="flex flex-col gap-4 pt-4">
          ...
          />
          <TextField
            label="Orden" type="number" value={topicForm.sortOrder}
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleSaveTopic} disabled={!topicForm.title}>
            Guardar
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={itemDialogOpen} onClose={() => setItemDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleSaveItem} disabled={!itemForm.title || !itemForm.content}>
            Guardar
          </Button>
        </DialogActions>
      </Dialog>
