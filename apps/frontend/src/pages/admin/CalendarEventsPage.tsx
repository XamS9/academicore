...
export default function CalendarEventsPage() {
  ...
  const columns: Column<CalendarEvent>[] = [
    { key: "title", label: "Título", render: (r) => r.title },
    {
      ...
      render: (r) => (
        <Chip
          label={eventTypeLabels[r.eventType] ?? r.eventType}
          color={eventTypeColors[r.eventType] ?? "default"}
          size="small"
        />
      ),
    },
    {
      key: "startDate",
      label: "Inicio",
      render: (r) => new Date(r.startDate).toLocaleDateString("es-MX"),
    },
    {
      key: "endDate",
      label: "Fin",
      render: (r) => new Date(r.endDate).toLocaleDateString("es-MX"),
    },
    {
      key: "actions",
      label: "Acciones",
