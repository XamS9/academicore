...
export default function PaymentsPage() {
  ...
  const loadConcepts = () =>
    paymentsService
      .getFeeConcepts()
      .then(setConcepts)
      .catch(() => showToast("Error al cargar conceptos", "error"));
  const loadFees = () =>
    paymentsService
      .getStudentFees()
      .then(setFees)
  ...
  const handleCreateConcept = async () => {
    try {
      await paymentsService.createFeeConcept({
        ...conceptForm,
      ...
      showToast("Error al crear concepto", "error");
    }
  };

  const handleAssignFee = async () => {
    try {
      await paymentsService.assignFee({
        ...assignForm,
      ...
      >
        ...
        <DialogContent className="flex flex-col gap-4 pt-2">
          <TextField
            ...
            onChange={(e) =>
              setConceptForm({ ...conceptForm, name: e.target.value })
            }
            fullWidth
            margin="dense"
          />
          <TextField
            ...
            onChange={(e) => {
              ...
              if (v === "" || /^\d*\.?\d*$/.test(v)) {
                setConceptForm({ ...conceptForm, amount: v });
              }
            }}
            fullWidth
            margin="dense"
          ...
          <TextField
            ...
            onChange={(e) =>
              setConceptForm({ ...conceptForm, description: e.target.value })
            }
            fullWidth
            margin="dense"
          />
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleCreateConcept}>
            Crear
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent className="flex flex-col gap-4 pt-2">
          ...
          <TextField
            ...
            onChange={(e) =>
              setAssignForm({ ...assignForm, periodId: e.target.value })
            }
            fullWidth
            margin="dense"
          >
          ...
          <TextField
            ...
            onChange={(e) => {
              const v = e.target.value;
              if (v === "" || /^\d*\.?\d*$/.test(v)) {
                setAssignForm({ ...assignForm, amount: v });
              }
            }}
            fullWidth
            margin="dense"
