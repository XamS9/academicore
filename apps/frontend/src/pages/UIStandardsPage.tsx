...
const colors = [
  ...
  },
  {
    name: "Success",
    hex: "#2e7d32",
    usage: "Materias aprobadas, estado ACTIVO, confirmaciones",
  },
  {
    name: "Warning",
    hex: "#ed6c02",
    usage: "Estado EN_RIESGO, alertas de atención",
  },
  {
    name: "Error",
    hex: "#d32f2f",
    usage: "Materias reprobadas, estado SUSPENDIDO, errores",
  },
  {
    name: "Info",
    hex: "#0288d1",
    usage: "Información adicional, notificaciones neutras",
  },
  { name: "Gris 100", hex: "#f5f5f5", usage: "Fondos de tablas, cabeceras" },
  {
    name: "Gris 400",
    hex: "#bdbdbd",
    usage: "Bordes, separadores, elementos deshabilitados",
  },
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 4 }}>
        Guía visual completa del sistema de diseño utilizado en Academicore.
        Todos los componentes son de MUI v6 con espaciado base de 8px y paleta
        institucional.
      </Typography>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Alert severity="info" sx={{ maxWidth: 400 }}>
              <strong>DatePicker:</strong> Usar <code>@mui/x-date-pickers</code>{" "}
              con adapter de date-fns para campos de fecha. Validación de
              esquemas con Zod en el backend; errores inline en frontend.
            </Alert>
          </Grid>
        </Grid>
      </Section>
        ...
        <Box className="flex flex-col gap-4">
          <Box>
            <Typography variant="subtitle2" fontWeight={700} gutterBottom>
              Estado Académico (AcademicStatus)
            </Typography>
          ...
          <Box>
            <Typography variant="subtitle2" fontWeight={700} gutterBottom>
              Estado Materia Inscrita (EnrollmentSubjectStatus)
            </Typography>
            <Box className="flex flex-wrap gap-2">
          ...
          <Box>
            <Typography variant="subtitle2" fontWeight={700} gutterBottom>
              Estado Certificación (CertificationStatus)
            </Typography>
            <Box className="flex flex-wrap gap-2">
      ...
      <Section title="Tablas de Datos" number={6}>
        <Alert severity="info" sx={{ mb: 2 }}>
          Las tablas usan MUI <code>Table</code> con <code>size="small"</code>,
          cabeceras en <code>grey.100</code>, hover en filas, y columna de
          acciones al final. Para grandes volúmenes usar MUI DataGrid de{" "}
        ...
        >
          Las tablas soportan: ordenamiento por columna, paginación, filtro por
          estado, y acciones por fila.
        </Typography>
      </Section>
      ...
      <Section title="Navegación" number={7}>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          El sidebar es permanente en pantallas ≥ lg (1200px) y temporal
          (drawer) en móvil/tablet. Se resalta la ruta activa con fondo de color
          primario.
        </Typography>
          ...
          <Paper variant="outlined">
            ...
            <Box sx={{ p: 2 }}>
              <Typography variant="body2" color="text.secondary">
                Contenido del tab {tabValue + 1}. Los tabs se usan para agrupar
                subprocesos dentro de una misma página.
              </Typography>
            </Box>
          </Paper>
        </Box>
          ...
          <Grid item xs={12} sm={6} md={5}>
            <Card variant="outlined">
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Para mostrar información contextual sobre una entidad del
                  sistema, con ícono representativo y datos relevantes
          ...
          <Grid item xs={12}>
            ...
            <Box className="flex flex-col gap-2">
              ...
              <Alert severity="warning">
                Atención: el promedio del estudiante está en riesgo.
              </Alert>
              <Alert severity="error">
                Error: No se pudo completar la inscripción.
              </Alert>
              <Alert severity="info">
                Información: Los certificados vencen a los 12 meses.
              </Alert>
            </Box>
          </Grid>
        </Grid>
      ...
      <Section title="Diálogos y Retroalimentación" number={9}>
        ...
        >
          ...
          <DialogContent>
            <Typography variant="body2">
              ¿Está seguro de que desea realizar esta acción? Esta operación no
              se puede deshacer.
            </Typography>
          </DialogContent>
          <DialogActions>
        ...
        <Box>
          ...
          <Box className="flex items-center gap-4">
            ...
            <Typography variant="body2" color="text.secondary">
              Se usa CircularProgress para indicar operaciones en curso (login,
        ...
        <Alert severity="info" sx={{ mt: 2 }}>
          <strong>Snackbar:</strong> Las notificaciones de éxito/error se
          muestran con <code>MUI Snackbar</code> en la esquina inferior derecha
          con <code>autoHideDuration={4000}</code>.
        </Alert>
      </Section>
      ...
      <Section title="Principios Generales de Diseño" number={10}>
        <Grid container spacing={2}>
          {[
            {
              title: "Idioma",
              desc: "Todo el contenido de la UI está en español. Los códigos técnicos y enums pueden estar en inglés (e.g., ACTIVE, COMPLETED).",
            },
            {
              title: "Íconos",
              desc: "Se usan exclusivamente íconos de Material Icons (@mui/icons-material). Preferir íconos descriptivos sobre texto genérico.",
            },
            {
              title: "Espaciado",
              desc: "Sistema de espaciado MUI con base 8px. Usar theme.spacing() o clases de Tailwind (p-2 = 8px, p-4 = 16px, gap-3 = 12px).",
            },
            {
              title: "Responsive",
              desc: "Mobile-first. Sidebar temporal en xs/sm/md, permanente en lg+. Grid breakpoints: xs=12, sm=6, md=4, lg=3.",
            },
            {
              title: "Validación",
              desc: "Backend: Zod schema validation. Frontend: errores inline bajo cada campo, Alert para errores globales del formulario.",
            },
            {
              title: "Coexistencia MUI + Tailwind",
              desc: 'Tailwind solo para layout/spacing (flex, gap, p-*). MUI para componentes. La config important: "#root" evita conflictos de especificidad CSS.',
            },
          ].map((p) => (
