...
const STEPS = ["Datos personales", "Seleccionar carrera", "Confirmar"];
...
export default function RegisterPage() {
        ...
        <Card sx={{ maxWidth: 480, width: "100%", mx: 2 }}>
          <CardContent sx={{ p: 4, textAlign: "center" }}>
            ...
            <Typography color="text.secondary" sx={{ mb: 1 }}>
              Tu solicitud ha sido recibida. Un administrador revisará tu cuenta
              y la activará en breve.
            </Typography>
  ...
  return (
    ...
    >
      <Card sx={{ maxWidth: step === 1 ? 720 : 480, width: "100%", mx: 2 }}>
        <CardContent sx={{ p: 4 }}>
          {/* Header */}
                        ...
                        >
                          ...
                          >
                            ...
                            <Box sx={{ display: "flex", gap: 1, mt: 1, flexWrap: "wrap" }}>
                              <Chip label={career.code} size="small" variant="outlined" />
                              <Chip
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              >
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <Typography variant="body2" fontWeight={600}>{selectedCareer.name}</Typography>
                </Box>
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                  <Typography variant="body2" color="text.secondary">Duración</Typography>
                  <Typography variant="body2" fontWeight={600}>{selectedCareer.totalSemesters} semestres</Typography>
                </Box>
              </Box>
              <Alert severity="info" icon={false}>
                Tu cuenta quedará <strong>pendiente de aprobación</strong>. El
                equipo administrativo verificará tu solicitud y te notificará
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", mt: 4 }}>
            ...
            {step < 2 ? (
              <Button variant="contained" onClick={handleNext} sx={{ fontWeight: 700 }}>
                Siguiente
              </Button>
            ) : (
              <Button
                ...
                sx={{ fontWeight: 700 }}
              >
                {submitting ? <CircularProgress size={22} color="inherit" /> : "Enviar solicitud"}
              </Button>
            )}
          </Box>
