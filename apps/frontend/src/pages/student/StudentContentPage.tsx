          ...
          e.enrollmentSubjects
            ...
            .map((es) => ({
              ...
              teacherName: es.group.teacher?.user
                ...
                : "",
              subject: { prerequisites: es.group.subject.prerequisites },
            })),
        );
                ...
                >
                  ...
                  >
                    <CardContent sx={{ pb: 2 }}>
                      ...
                      <SubjectPrerequisitesCaption subject={card.subject} sx={{ mb: 1 }} />
  ...
  return (
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <SubjectPrerequisitesCaption subject={selectedCard.subject} />
      </Box>
